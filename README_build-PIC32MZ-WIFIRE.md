...
The Espruino project uses an MIT license. Microchip contributed files use an Apache license. This means that no GPL code should be added to the repository. Also, no Microchip Harmony files should be committed.

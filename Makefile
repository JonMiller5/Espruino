...
# PIC32MZ_EF_WIFIRE=1     # chipKIT WiFire board with PIC32MZ2048EFG100
...
else ifdef PIC32MZ_EF_WIFIRE
EMBEDDED=1
BOARD=PIC32MZ_WIFIRE
OPTIMIZEFLAGS+=-Og
MPLABXC32=1
PIC32MZ_EF_WIFIRE_USART=1
XC32PROCESSOR=32MZ2048EFG100
F_CPU = 200000000
...
MICROCHIP_HARMONY_PATH=$(HOME)/microchip/harmony/v2_01b
endif

ifdef PIC32MZ_EF_STARTERKIT
INCLUDE +=                                      \
...
INCLUDE +=                                      \
  -I$(MICROCHIP_HARMONY_PATH)/framework \
  -I./targets/pic32mzef \
  -I./targets/pic32mzef/wifire/Harmony-MHC/firmware/src \
  -I./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire \
...
SOURCES +=                                                                     \
 ...
 # Most of these files are generated by the Microchip Harmony Configurator and are not provided with the project
 SOURCES +=                                                                    \
 ./targets/pic32mzef/wifire/sanity_tests.c                                     \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/bsp/bsp.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/framework/driver/usart/src/drv_usart_mapping.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/framework/driver/usart/src/drv_usart_static.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/framework/driver/usart/src/drv_usart_static_byte_model.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/framework/system/clk/src/sys_clk_static.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/framework/system/ports/src/sys_ports_static.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/system_exceptions.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/system_init.c \
 ./targets/pic32mzef/wifire/Harmony-MHC/firmware/src/system_config/wifire/system_tasks.c \
 $(MICROCHIP_HARMONY_PATH)/framework/driver/tmr/src/dynamic/drv_tmr.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/devcon/src/sys_devcon.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/devcon/src/sys_devcon_pic32mz.c \
 $(MICROCHIP_HARMONY_PATH)/framework/system/devcon/src/sys_devcon_cache_pic32mz.S  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/fs/src/dynamic/sys_fs.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/fs/src/dynamic/sys_fs_media_manager.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/fs/fat_fs/src/file_system/ff.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/fs/fat_fs/src/hardware_access/diskio.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/int/src/sys_int_pic32.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/system/tmr/src/sys_tmr.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/driver/usb/usbhs/src/dynamic/drv_usbhs.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/usb/src/dynamic/usb_host.c  \
 $(MICROCHIP_HARMONY_PATH)/framework/driver/usb/usbhs/src/dynamic/drv_usbhs_host.c  \
